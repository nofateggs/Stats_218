...
#fit2 <- ergm(
  #but_net ~ edges + ctriple + ttriple + dgwest(0.5, fixed = TRUE) + dgwdsp(0.5, fixed = TRUE)
#)

#fit3 <- ergm(
  #but_net ~ edges + istar(2) + ostar(2) + ctriple + ttriple + gwodegree(0.5, fixed = TRUE) + gwidegree(0.5, fixed = TRUE)
#)
