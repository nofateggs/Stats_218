...
```{r}
plot(hansell,
     vertex.col = ifelse(network::get.vertex.attribute(hansell, "sex") == "male", "blue", "red"),
     edge.col = "grey")
```
...
the coefficient for nodematch.sex is 1.81462 with a very small p-value (< 1e-04), which suggests that there is a statistically significant preference for same-sex friendships in this network.

The coefficient for mutual is 0.80159 with a p-value of 0.07782, which is marginally significant at the 10% level, which suggests a weak, positive preference for mutual friendship ties.
...
points(x = 3.21023833, y = -0.8821910, pch = 19, col = "blue")
points(x = 1.45887113, y = -0.1697109, pch = 19, col = "blue")
points(x = -0.75712934, y = 1.4261249, pch = 19, col = "orange")
points(x = -3.09881424, y = 1.1535489, pch = 19, col = "orange")
